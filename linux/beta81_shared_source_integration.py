#!/usr/bin/env python3
"""Linux delivery adapter for the exact beta.81 shared browser source.
...
_APPLIED=False
_STACK = b'''\n<!-- CP beta.81 shared WebView stack; Linux transport only -->
...
<script>document.documentElement.dataset.chesspublisherLinuxBuild='1.06.00-beta.81';</script>
'''
...
def _transform_html(data: bytes) -> bytes:
    if b'CP beta.81 shared WebView stack' in data: return data
