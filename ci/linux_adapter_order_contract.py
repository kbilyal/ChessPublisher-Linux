...
shared=entry.find('apply_shared_source()');platform=entry.find('apply_pairings_result_desk()')
if min(shared,platform)<0 or not platform<shared:raise RuntimeError('shared-source delivery adapter must be last')
